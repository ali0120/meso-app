...
export const  GET_ALL_PRODUCT_BEGIN = ' GET_ALL_PRODUCT_BEGIN '
export const GET_ALL_PRODUCT_SUCCESS = 'GET_ALL_PRODUCT_SUCCESS '

export const GET_ABOUT_DATA_BEGIN = 'GET_ABOUT_DATA_BEGIN '
export const GET_ABOUT_DATA_SUCCESS = 'GET_ABOUT_DATA_SUCCESS '


export const GET_CONTACT_DATA_BEGIN = 'GET_CONTACT_DATA_BEGIN '
